 ...
 */
public class LecturereoomTopBanner extends LinearLayout {
    ...
    public LecturereoomTopBanner(Context context) {
        super(context);

    }

    public LecturereoomTopBanner(final Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        inflater.inflate(R.layout.lectureroom_top_banner_view, this);
    ...
    private void initView(final Context context) {
        ...
        tv_banner_title.setText(titleList.get(0));

        TextPaint tp = tv_banner_title.getPaint();
        ...
        adViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                //设置每一页的点
                if (position == 3) {
                    iv_lead_spot1.setImageResource(R.drawable.lectureroom_top_banner_show);
                    iv_lead_spot2.setImageResource(R.drawable.lectureroom_top_banner_show);
                    iv_lead_spot3.setImageResource(R.drawable.lectureroom_top_banner_show);
                    iv_lead_spot4.setImageResource(R.drawable.lectureroom_top_banner_noshow);
                    tv_banner_title.setText(titleList.get(3));
                } else if (position == 0) {
                    iv_lead_spot1.setImageResource(R.drawable.lectureroom_top_banner_noshow);
                    iv_lead_spot2.setImageResource(R.drawable.lectureroom_top_banner_show);
                    iv_lead_spot4.setImageResource(R.drawable.lectureroom_top_banner_show);
                    iv_lead_spot3.setImageResource(R.drawable.lectureroom_top_banner_show);
                    tv_banner_title.setText(titleList.get(0));
                } else if (position == 1) {
                    iv_lead_spot1.setImageResource(R.drawable.lectureroom_top_banner_show);
                    iv_lead_spot2.setImageResource(R.drawable.lectureroom_top_banner_noshow);
                    iv_lead_spot4.setImageResource(R.drawable.lectureroom_top_banner_show);
                    iv_lead_spot3.setImageResource(R.drawable.lectureroom_top_banner_show);
                    tv_banner_title.setText(titleList.get(1));
                } else if (position == 2) {
                    iv_lead_spot1.setImageResource(R.drawable.lectureroom_top_banner_show);
                    iv_lead_spot2.setImageResource(R.drawable.lectureroom_top_banner_show);
                    iv_lead_spot4.setImageResource(R.drawable.lectureroom_top_banner_show);
                    iv_lead_spot3.setImageResource(R.drawable.lectureroom_top_banner_noshow);
                    tv_banner_title.setText(titleList.get(2));
                }
            }
