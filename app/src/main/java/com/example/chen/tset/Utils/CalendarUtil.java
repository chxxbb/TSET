...
public class CalendarUtil {
    ...
    public String judgefestival(int m, int d, String lund) {
        if (m == 1 && d == 1) {
            return "元旦";
        } else if (m == 3 && d == 8) {
            return "妇女节";
            ...
            return "国庆节";
        } else if (lund.equals("腊月三十")) {
            return "除夕";
        } else if (lund.equals("正月十五")) {
            return "元宵";
        } else if (lund.equals("五月初五")) {
            return "端午";
        } else if (lund.equals("七月初七")) {
            return "七夕";
        } else if (lund.equals("七月十五")) {
            return "中元";
        } else if (lund.equals("八月十五 ")) {
            return "中秋";
        } else if (lund.equals("九月初九 ")) {
            return "重阳";
        } else if (lund.equals("腊月初八")) {
            return "腊八";
        } else if (m == 2 & d == 14) {
            return "情人节";
        } else if (m == 12 && d == 25) {
